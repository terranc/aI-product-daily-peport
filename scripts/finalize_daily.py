...
# Selected Products (Top 5)
# We'll use the IDs from raw candidates to ensure consistency
SELECTED_PRODUCTS = [
    {
        "id": "producthunt.com/r/p/1170951",
        "name": "Memoriq",
        "slug": "memoriq",
        "description": "一款私密的 AI 记忆保险库，支持保存和管理来自 ChatGPT、Claude 等平台的对话历史。",
        "url": "https://memoriq.me/",
        "homepage": "https://memoriq.me/",
        "type": "website",
        "tags": ["AI 记忆", "知识管理", "隐私保护", "效率工具"],
        "sourceChannels": ["producthunt"],
        "sourceUrl": "https://www.producthunt.com/r/p/1170951?app_id=339",
        "analysis": {
    ...
    {
        "id": "producthunt.com/r/p/1171217",
        "name": "Slashy",
        "slug": "slashy",
        "description": "一个 AI 原生的邮件助手，能以你的语气起草回复、分类邮件并追踪待办。",
        "url": "https://slashy.ai/",
        "homepage": "https://slashy.ai/",
        "type": "website",
        "tags": ["AI 邮件", "办公自动化", "沟通协作", "效率提升"],
        "sourceChannels": ["producthunt"],
        "sourceUrl": "https://www.producthunt.com/r/p/1171217?app_id=339",
        "analysis": {
    ...
    {
        "id": "producthunt.com/r/p/1139531",
        "name": "Allergo",
        "slug": "allergo",
        "description": "利用 AI 生成多语言过敏原翻译卡片，帮助旅行者在海外安全饮食。",
        "url": "https://allergo.app/",
        "homepage": "https://allergo.app/",
        "type": "website",
        "tags": ["旅行工具", "健康安全", "AI 翻译", "生活服务"],
        "sourceChannels": ["producthunt"],
        "sourceUrl": "https://www.producthunt.com/r/p/1139531?app_id=339",
        "analysis": {
    ...
    {
        "id": "producthunt.com/r/p/1169603",
        "name": "LocIn AI",
        "slug": "locin-ai",
        "description": "AI 驱动的应用本地化工具，能够根据品牌语调自动翻译并优化应用内容。",
        "url": "https://locin.ai/",
        "homepage": "https://locin.ai/",
        "type": "website",
        "tags": ["AI 本地化", "开发者工具", "翻译", "品牌语调"],
        "sourceChannels": ["producthunt"],
        "sourceUrl": "https://www.producthunt.com/r/p/1169603?app_id=339",
        "analysis": {
    ...
    {
        "id": "producthunt.com/r/p/1170971",
        "name": "Taste Lab",
        "slug": "taste-lab",
        "description": "通过 AI 提取任何网站的设计 DNA，包括配色、字体和布局风格。",
        "url": "https://taste.lab/",
        "homepage": "https://taste.lab/",
        "type": "website",
        "tags": ["UI 设计", "设计分析", "竞品研究", "AI 辅助设计"],
        "sourceChannels": ["producthunt"],
        "sourceUrl": "https://www.producthunt.com/r/p/1170971?app_id=339",
        "analysis": {
...
def main():
    ...
    for prod in SELECTED_PRODUCTS:
        report_prod = prod.copy()
        report_prod['firstSeen'] = now_iso
        report_prod['appStoreName'] = None
        report_prod['appStoreUrl'] = None
        report_prod['screenshotUrl'] = None # Screenshots skipped for now due to timeout
        report_prod['appStoreScreenshots'] = []
        report_products.append(report_prod)
        
    report = {
        "date": today_str,
        "generatedAt": now_iso,
        "productCount": len(report_products),
    ...
    cooldown_expire = (datetime.now(timezone.utc) + timedelta(days=14)).isoformat()
    
    for prod in SELECTED_PRODUCTS:
        db_prod = prod.copy()
        db_prod['cooldownExpiresAt'] = cooldown_expire
        db_prod['metrics'] = {
            "weeklyViews": 0,
            "growthRate": 0,
        ...
        db_prod['firstSeen'] = now_iso
        db_prod['lastSeen'] = now_iso
        
        exists = False
        for i, existing in enumerate(db['products']):
            if existing.get('id') == prod['id']:
                db['products'][i].update(db_prod)
                exists = True
                break
        if not exists:
            db['products'].append(db_prod)
