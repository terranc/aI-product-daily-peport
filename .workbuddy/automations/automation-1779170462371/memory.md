...
- **选择理由**：Ahrefs 是 SEO 行业龙头品牌（44% 财富 500 强使用），16 年零融资创业传奇（$0 外部投资、无销售团队、$150M ARR），Agent A 是其向 AI Agent 范式转型的战略产品
- **深度报告**：已保存至 `reports/weekly/2026-07-13.json`
- **关键发现**：
  - 创始人 Dmytro Gerasimenko 单人编程起家，$30 万自筹资金，16 年做到 $1.5 亿 ARR
  - 团队仅 ~171 人遍布 26 国，人均创收 $87 万（超过 Google/Meta）
  - AhrefsBot 爬虫是互联网第二活跃的爬虫（仅次于 Google），数据护城河不可复制
  - Agent A 基于 Letaido 平台，支持 Claude Opus/GPT-5/DeepSeek 多模型切换
  - 实际全量使用（含 Brand Radar AI 引用追踪）成本为 $827/月，远超 $99 起步价
  - 评测 FSR 评价：「The agent is good. The bill is bigger than advertised.」
- **部署状态**：已标记 featuredInWeekly，已推送到 GitHub Pages
- **GitHub Pages**：https://ai-daily.asdasd.vip
